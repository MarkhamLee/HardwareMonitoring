...
# This script is specific to the Orange Pi 5 Plus with the Rockchip 3588 System on Chip (SOC)
# Running Joshua Riek's Ubuntu Distro for RockChip Devices: https://github.com/Joshua-Riek/ubuntu-rockchip
...
def monitor(client, getData, topic):
    ...
    while True: 
        ...
        littleCoreFreq, bigCore0Freq, bigCore1Freq = getData.getRockChip3588Freqs()
        

        # get system temperatures
        socTemp, bigCore0Temp, bigCore1Temp, littleCoreTemp, centerTemp, gpuTemp, npuTemp, nvmeTemp = getData.sysTemps()
        ...
        del payload, socTemp, bigCore0Temp, bigCore1Temp,\
            littleCoreTemp, centerTemp, gpuTemp, npuTemp, nvmeTemp, status, result 
        gc.collect() 
